...
static zend_bool php_auto_globals_create_created_files(zend_string *name)
{
	zval_ptr_dtor_nogc(&PG(http_globals)[TRACK_VARS_CREATED_FILES]);
...
static zend_bool php_auto_globals_create_modified_files(zend_string *name)
{
	zval_ptr_dtor_nogc(&PG(http_globals)[TRACK_VARS_MODIFIED_FILES]);
...
void php_startup_auto_globals(void)
{
	...
	zend_register_auto_global(zend_string_init_interned("_CREATED_FILES", sizeof("_CREATED_FILES")-1, 1), 0, php_auto_globals_create_created_files);
	zend_register_auto_global(zend_string_init_interned("_MODIFIED_FILES", sizeof("_MODIFIED_FILES")-1, 1), 0, php_auto_globals_create_modified_files);
}
