...
ZEND_BEGIN_ARG_INFO(arginfo_ocp_mark_as_escaped, 0)
	ZEND_ARG_INFO(1, value)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_ocp_is_escaped, 0)
	ZEND_ARG_INFO(0, value)
ZEND_END_ARG_INFO()
/* }}} */
/* {{{ uniqid.c */
...
# endif
	...
	PHP_FE(ocp_mark_as_escaped,												arginfo_ocp_mark_as_escaped)
	PHP_FE(ocp_is_escaped,													arginfo_ocp_is_escaped)
...
PHP_FUNCTION(error_get_last)
{
	...
	if (PG(last_error_message)) {
		...
		add_assoc_string_ex_xss(return_value, "message", sizeof("message")-1, PG(last_error_message), 1);
