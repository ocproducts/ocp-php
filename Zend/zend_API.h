...
ZEND_API int add_assoc_string_ex_xss(zval *arg, const char *key, size_t key_len, const char *str, int escaped);
ZEND_API int add_assoc_stringl_ex(zval *arg, const char *key, size_t key_len, const char *str, size_t length);
ZEND_API int add_assoc_stringl_ex_xss(zval *arg, const char *key, size_t key_len, const char *str, size_t length, int escaped);
...
#define add_assoc_str_xss(__arg, __key, __str, __escaped) add_assoc_str_ex(__arg, __key, strlen(__key), __str, __escaped)
#define add_assoc_string(__arg, __key, __str) add_assoc_string_ex(__arg, __key, strlen(__key), __str)
#define add_assoc_string_xss(__arg, __key, __str, __escaped) add_assoc_string_ex(__arg, __key, strlen(__key), __str, __escaped)
#define add_assoc_stringl(__arg, __key, __str, __length) add_assoc_stringl_ex(__arg, __key, strlen(__key), __str, __length)
#define add_assoc_stringl_xss(__arg, __key, __str, __length, __escaped) add_assoc_stringl_ex(__arg, __key, strlen(__key), __str, __length, __escaped)
...
ZEND_API int add_index_string_xss(zval *arg, zend_ulong idx, const char *str, int escaped);
ZEND_API int add_index_stringl(zval *arg, zend_ulong idx, const char *str, size_t length);
ZEND_API int add_index_stringl_xss(zval *arg, zend_ulong idx, const char *str, size_t length, int escaped);
...
ZEND_API int add_next_index_string_xss(zval *arg, const char *str, int escaped);
ZEND_API int add_next_index_stringl(zval *arg, const char *str, size_t length);
ZEND_API int add_next_index_stringl_xss(zval *arg, const char *str, size_t length, int escaped);
ZEND_API int add_next_index_zval(zval *arg, zval *value);

ZEND_API zval *add_get_assoc_string_ex(zval *arg, const char *key, uint32_t key_len, const char *str);
ZEND_API zval *add_get_assoc_string_ex_xss(zval *arg, const char *key, uint32_t key_len, const char *str, int escaped);
ZEND_API zval *add_get_assoc_stringl_ex(zval *arg, const char *key, uint32_t key_len, const char *str, size_t length);
ZEND_API zval *add_get_assoc_stringl_ex_xss(zval *arg, const char *key, uint32_t key_len, const char *str, size_t length, int escaped);
...
#define add_get_assoc_stringl_xss(__arg, __key, __str, __length, __escaped) add_get_assoc_stringl_ex(__arg, __key, strlen(__key), __str, __length, __escaped)
...
ZEND_API int add_property_string_ex_xss(zval *arg, const char *key, size_t key_len, const char *str, int escaped);
ZEND_API int add_property_stringl_ex(zval *arg, const char *key, size_t key_len,  const char *str, size_t length);
ZEND_API int add_property_stringl_ex_xss(zval *arg, const char *key, size_t key_len,  const char *str, size_t length, int escaped);
...
#define ZVAL_STRINGL_XSS(z, s, l, escaped) do {				\
		ZVAL_NEW_STR(z, zend_string_init_xss(s, l, 0, escaped));		\
	} while (0)
...
#define ZVAL_STRING_XSS(z, s, escaped) do {					\
		const char *_s = (s);					\
		ZVAL_STRINGL_XSS(z, _s, strlen(_s), escaped);		\
	} while (0)
...
#define RETVAL_INTERNED_STR_XSS(s, escaped)	ZVAL_INTERNED_STR_XSS(return_value, s, escaped)
#define RETVAL_NEW_STR(s)		 		ZVAL_NEW_STR(return_value, s)
#define RETVAL_NEW_STR_XSS(s, escaped)		ZVAL_NEW_STR_XSS(return_value, s, escaped)
#define RETVAL_STR_COPY(s)		 		ZVAL_STR_COPY(return_value, s)
#define RETVAL_STRING(s)		 		ZVAL_STRING(return_value, s)
#define RETVAL_STRING_XSS(s, escaped)		ZVAL_STRING_XSS(return_value, s, escaped)
#define RETVAL_STRINGL(s, l)		 	ZVAL_STRINGL(return_value, s, l)
#define RETVAL_STRINGL_XSS(s, l, escaped)	ZVAL_STRINGL_XSS(return_value, s, l, escaped)
...
#define RETURN_INTERNED_STR_XSS(s, escaped)	{ RETVAL_INTERNED_STR_XSS(s, escaped); return; }
#define RETURN_NEW_STR(s)				{ RETVAL_NEW_STR(s); return; }
#define RETURN_NEW_STR_XSS(s, escaped)		{ RETVAL_NEW_STR_XSS(s, escaped); return; }
#define RETURN_STR_COPY(s)				{ RETVAL_STR_COPY(s); return; }
#define RETURN_STRING(s) 				{ RETVAL_STRING(s); return; }
#define RETURN_STRING_XSS(s, escaped) 		{ RETVAL_STRING_XSS(s, escaped); return; }
#define RETURN_STRINGL(s, l) 			{ RETVAL_STRINGL(s, l); return; }
#define RETURN_STRINGL_XSS(s, l, escaped)	{ RETVAL_STRINGL_XSS(s, l, escaped); return; }
