...
static zend_always_inline zend_string *zend_string_alloc_xss(size_t len, int persistent, int escaped)
{
...
{
	return zend_string_alloc_xss(len, persistent, 0);
}

static zend_always_inline zend_string *zend_string_safe_alloc_xss(size_t n, size_t m, size_t l, int persistent, int escaped)
{
...
{
	return zend_string_safe_alloc_xss(n, m, l, persistent, 0);
}

static zend_always_inline zend_string *zend_string_init_xss(const char *str, size_t len, int persistent, int escaped)
{
...
{
	return zend_string_init_xss(str, len, persistent, 0);
}
